...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Kontak' link to open the contact page and reveal the contact form.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/nav/div/div[2]/ul/li[5]/a').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Click the 'Kirim Pesan' submit button with all fields empty, then wait for validation feedback to appear.
        frame = context.pages[-1]
        # Click element
